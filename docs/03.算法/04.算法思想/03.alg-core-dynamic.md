...
permalink: /pages/alg-core-dynamic/
categories:
  - 算法
tags:
  - 
...
![](https://latex.codecogs.com/gif.latex?dp[i]=dp[i-1]+dp[i-2])
...
![](https://latex.codecogs.com/gif.latex?dp[i]=(i-1)*dp[i-2]+(i-1)*dp[i-1])
...
![](https://latex.codecogs.com/gif.latex?dp[i]=dp[i-1]+dp[i-3])
...
![img](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/7c98e1b6-c446-4cde-8513-5c11b9f52aea.jpg)
...
![](https://latex.codecogs.com/gif.latex?dp[n]=max\{1,dp[i]+1|S_i<S_n\&\&i<n\})
...
![](https://latex.codecogs.com/gif.latex?dp[i][j]=\left\{\begin{array}{rcl}dp[i-1][j-1]&&{S1_i==S2_j}\\max(dp[i-1][j],dp[i][j-1])&&{S1_i<>S2_j}\end{array}\right.)
...
![](https://latex.codecogs.com/gif.latex?dp[i][j]=max(dp[i-1][j],dp[i-1][j-w]+v))
...
![img](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/a3da4342-078b-43e2-b748-7e71bec50dc4.png)
...
![img](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/61942711-45a0-4e11-bbc9-434e31436f33.png)
