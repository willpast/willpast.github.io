---
title: 调试排错 - 内存分析之堆外内存
date: 2024-05-22 13:45:32
permalink: /pages/java-jvm-oom-offheap/
tags: 
  - null
author: 
  name: Cyan
...
![image-20220825215559298](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825215559298.png)
...
![image-20220825215747039](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825215747039.png)
...
![image-20220825215847183](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825215847183.png)
...
![image-20220825215952863](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825215952863.png)
...
![image-20220825220050258](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220050258.png)
...
![image-20220825220135272](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220135272.png)
...
![image-20220825220221582](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220221582.png)

使用该mmap申请的地址空间在pmap对应如下：

![image-20220825220237025](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220237025.png)

#### 2.2.5 最后，使用jstack去查看对应的线程

因为strace命令中已经显示申请内存的线程ID。直接使用命令jstack pid去查看线程栈，找到对应的线程栈（注意10进制和16进制转换）如下：

![image-20220825220300342](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220300342.png)

这里基本上就可以看出问题来了：MCC（美团统一配置中心）使用了Reflections进行扫包，底层使用了Spring Boot去加载JAR。因为解压JAR使用Inflater类，需要用到堆外内存，然后使用Btrace去追踪这个类，栈如下：

![image-20220825220334012](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220334012.png)
...
![image-20220825220540538](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220540538.png)

到此，基本上可以确定是内存分配器在捣鬼；搜索了一下glibc 64M，发现glibc从2.11开始对每个线程引入内存池（64位机器大小就是64M内存），原文如下：

![image-20220825220614752](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220614752.png)
...
![image-20220825220652536](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220652536.png)
...
![image-20220825220804117](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220825220804117.png)
