...
![image-20220830215211727](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220830215211727.png)
...
![image-20220830215408687](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220830215408687.png)
...
![image-20220830220005378](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220830220005378.png)
...
![image-20220830220127233](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220830220127233.png)

- 注意，是询问操作系统。也就是说socket套接字的IO模式支持是基于操作系统的，那么自然同步IO/异步IO的支持就是需要操作系统级别的了。如下图:

![image-20220830220153365](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220830220153365.png)

![image-20220830220203544](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/image-20220830220203544.png)
