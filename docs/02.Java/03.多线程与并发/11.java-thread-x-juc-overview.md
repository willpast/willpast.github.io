---
title: JUC - 类汇总和学习指南
date: 2024-05-23 11:44:22
permalink: /pages/java-thread-x-juc-overview/
categories:
  - Java
  - 多线程与并发
tags:
...
> 本文对J.U.C(java.util.concurrent)进行知识体系解读，后续的文章还针对**几乎所有的核心的类**以及常用的`工具类`作了详细的解读; **如果没有时间详细阅读相关章节，可以跟着本文站在一定的高度了解JUC下包的设计和实现**；同时对重要的章节提供跳转链接，您可以链接过去详读。
...
![image](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/java-thread-x-juc-overview-1-u.png)
...
![image](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/java-thread-x-juc-overview-lock.png)接口: Condition
...
![image](https://cdn.jsdelivr.net/gh/willpast/image/blog/interview/java-thread-x-juc-overview-2.png)
...
![img](https://cdn.jsdelivr.net/gh/willpast/image/blog/interview/java-thread-x-juc-executors-1.png)
