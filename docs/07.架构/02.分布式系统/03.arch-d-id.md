...
![img](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/arch-z-id-6.png)
...
![img](https://cdn.jsdelivr.net/gh/willpast/image/blog/ka_java/arch-z-id-8.png)
...
对于节点重启频率频繁、期望长期使用的应用, 可增加工作机器位数和时间戳位数, 减少序列数位数.
