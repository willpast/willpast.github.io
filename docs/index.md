...
heroText: Cyan's blog
tagline: The pupil surpasses the master 青出于蓝胜于蓝
actionText: 立刻进入 →
actionLink: /overview/
...
features: # 可选的
  ...
  - title: 更多
    details: 管理方法、学习技巧、笔记总结、心灵鸡汤等文章
    link: /more/
    imgUrl: /img/more.png
...
- **Email**: <a href="mailto:lhhd_llz@163.com">lhhd_llz@163.com</a>
- **GitHub**: <https://github.com/willpast>
